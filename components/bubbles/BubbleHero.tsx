...
export default function HeroBubble() {
  return (
  <section className="relative min-h-[700px] lg:min-h-screen overflow-hidden">
        <Image
        src="/hero.png"
        alt="Happy Carneval"
        fill
...
<div className="relative z-10 mx-auto flex min-h-[700px] lg:min-h-screen items-center max-w-7xl px-5 pt-28 pb-12 lg:px-10">
                  <div className="w-full max-w-2xl rounded-[32px] bg-white/95 p-6 shadow-[0_20px_80px_rgba(0,0,0,0.12)] ring-1 ring-white/60 backdrop-blur-md sm:p-8 lg:rounded-[48px] lg:p-12">
            <span className="inline-flex rounded-full bg-pink-100 px-5 py-2 text-sm font-semibold text-pink-600">
              Burbulītes burbuļi
            </span>

            <h1 className="mt-6 text-4xl sm:text-5xl lg:text-7xl">
              Sveiki!
              <br />
              Es esmu{" "}
            ...
            <p className="mt-6 max-w-xl text-base leading-7 lg:text-lg lg:leading-8 text-gray-600">
